...
class add_to_dict_test(unittest.TestCase):
    ...
    def test_case_one(self):
        ...
        self.assertEqual(result_dict[result_keys[0]],expected_result[expected_keys[0]])
    ...
    def test_case_two(self):
        ...
        self.assertEqual(len(result_dict), len(expected_result))
        self.assertEqual(result_dict[result_keys[0]],expected_result[expected_keys[0]])
        self.assertEqual(result_dict[result_keys[1]],expected_result[expected_keys[1]])
        self.assertEqual(result_dict[result_keys[2]],expected_result[expected_keys[2]])
    ...
    def test_case_three(self):
        ...
        expected_result = {"Liam": 120, "Noah": 150, "William":115, "James": 250, "Lucas": 415}
        expected_keys = list(expected_result.keys())
        ...
        self.assertEqual(result_dict[result_keys[1]],expected_result[expected_keys[1]])
        self.assertEqual(result_dict[result_keys[2]],expected_result[expected_keys[2]])
        self.assertEqual(result_dict[result_keys[3]],expected_result[expected_keys[3]])
        self.assertEqual(result_dict[result_keys[4]],expected_result[expected_keys[4]])



class reset_counter_test(unittest.TestCase):
    def test_case_one(self):
        return_count = reset_counter({"arr":['', '', '', '', '', '', '', '', '']}, 10)
        # print(return_count)
    ...
    def test_case_two(self):
        return_count = reset_counter({"arr":['X', '', '', '', 'X', '', '', 'O', '']}, 20)
        # print(return_count)
    ...
    def test_case_three(self):
        return_count = reset_counter({"arr":['X', 'X', 'O', 'X', 'O', '', '', '', '']}, 30)
        # print(return_count)
